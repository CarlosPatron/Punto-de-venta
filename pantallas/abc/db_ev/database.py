    ...
    def selectCmd(self, opc, table, obj, action):
        if action=='add':
            if opc=='Producto':
                ...
                command = f"INSERT INTO {table} (nombre, ap_p, ap_m, phone, num_empleado, password, rol, status) VALUES ('{obj.nombre}', '{obj.ap_p}', '{obj.ap_m}', '{obj.phone}', '{obj.num_empleado}', '{obj.password}', '{obj.rol}', True);"
            elif opc=='Cliente':
